# Why is React-Lib-Components-Boilerplate a monorepo?

> The tool for managing the monorepo in this project has been extracted out as [Lerna](https://github.com/lerna/lerna)

Juggling a multimodule project over multiple repos is like trying to teach a newborn baby how to ride a bike.

This project follows a monorepo approach, all officially maintained modules are in the same repo.
